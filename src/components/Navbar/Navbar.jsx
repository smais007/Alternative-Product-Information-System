...
export default function Navbar() {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 shadow-sm sticky top-0 z-50 backdrop-filter backdrop-blur-lg bg-opacity-50 dark:bg-opacity-50 transition duration-500">
      {/* Blur effect */}
